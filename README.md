...
facing currently as the sales are not as expected and declining gradually.

## Solution

Sales director of the company, decided to build a PowerBI Dashboard for converting the data into 
visual representation to make data driven decisions. So, he hired a team of data people to complete this task.

### AIMS Grid

----
Using the AIMS grid project management tool, it was made sure what are the purpose, stakeholder, end result 
